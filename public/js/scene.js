...
class Scene {
  constructor() {
    ...
    // Helpers
    // PAULINE
    //this.scene.add(new THREE.GridHelper(50000, 50000));
  ...
  addClient(id) {
    ...
    this.fellowAstronauts.push(peerAstronaut);
  }
  ...
  update() {
    ...
    this.controls.update(this.avatar, this.fellowAstronauts, this.scene);
    this.render();
  }
  ...
  onWindowResize(e) {
    this.width = window.innerWidth;
    this.height = Math.floor(window.innerHeight * 0.75);
